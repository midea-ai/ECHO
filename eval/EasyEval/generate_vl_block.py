...
def parse_args():
    ...
    parser.add_argument("--model_dir", type=str, default="dChest_ckpt_blk4",
                        help="Path to the pretrained model directory")
    parser.add_argument("--image_path", type=str, default="CXRTest/mimic/files/p10/p10268877/s51513702/053e0fdd-17dbee89-17885e49-08249a30-7f829c9c.jpg",
    ...
    parser.add_argument(
        ...
        help="User prompt (override for Chinese-style prompts as needed)",
    )
